...
extern void* KMemsetW(void* Where,uint16_t val,uint32_t Bytes);
extern void* KMemcpy(void* Where,void* Destinition,uint32_t Bytes);
extern uint32_t Sin(uint32_t x);
extern uint32_t Cos(uint32_t x);
extern uint32_t Sqrt(uint32_t x);
extern uint32_t Round(uint32_t x);
